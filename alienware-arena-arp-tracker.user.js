...
(function () {
    ...
    const I18N = {
        en: {
            goCC: 'Click this line to go to its section of the Control Center.', goHere: 'Click this line to scroll to its section and highlight it.', goPass: 'Click this line to go to the Battle Pass.', goStore: 'Click this line to go to the Battle Store.', goVault: 'Click this line to go to the Game Vault and bid. It also marks the warning as seen.',
            ...
            tipTagDisc: 'With your artifact discount it costs {p} ARP instead of {l}, and you have {b}.',
        ...
        es: {
            goCC: 'Pulsa esta línea para ir a su sección del Centro de control.', goHere: 'Pulsa esta línea para bajar a su sección y resaltarla.', goPass: 'Pulsa esta línea para ir al pase de batalla.', goStore: 'Pulsa esta línea para ir a la tienda de batalla.', goVault: 'Pulsa esta línea para ir a la Bóveda y pujar. Además marca el aviso como visto.',
            ...
            tipTagDisc: 'Con el descuento de tu artefacto cuesta {p} ARP en vez de {l}, y tienes {b}.',
        ...
        de: {
            goCC: 'Klicke auf diese Zeile, um zu ihrem Abschnitt im Control Center zu gehen.', goHere: 'Klicke auf diese Zeile, um zu ihrem Abschnitt zu scrollen und ihn hervorzuheben.', goPass: 'Klicke auf diese Zeile, um zum Battle Pass zu gehen.', goStore: 'Klicke auf diese Zeile, um zum Battle Store zu gehen.', goVault: 'Klicke auf diese Zeile, um zum Game Vault zu gehen und zu bieten. Sie markiert die Warnung außerdem als gesehen.',
            ...
            tipTagDisc: 'Mit dem Rabatt deines Artefakts kostet es {p} ARP statt {l}, du hast {b}.',
        ...
        fr: {
            goCC: 'Clique sur cette ligne pour aller à sa section du Centre de contrôle.', goHere: 'Clique sur cette ligne pour descendre jusqu’à sa section et la mettre en évidence.', goPass: 'Clique sur cette ligne pour aller au pass de combat.', goStore: 'Clique sur cette ligne pour aller à la boutique de combat.', goVault: 'Clique sur cette ligne pour aller au Game Vault et enchérir. Elle marque aussi l’alerte comme vue.',
            ...
            tipTagDisc: 'Avec la remise de ton artefact, ça coûte {p} ARP au lieu de {l}, et tu en as {b}.',
        ...
        pt: {
            goCC: 'Prime esta linha para ires à sua secção do Centro de controlo.', goHere: 'Prime esta linha para desceres até à sua secção e a destacares.', goPass: 'Prime esta linha para ires ao passe de batalha.', goStore: 'Prime esta linha para ires à loja de batalha.', goVault: 'Prime esta linha para ires ao Cofre e licitar. Marca também o aviso como visto.',
            ...
            tipTagDisc: 'Com o desconto do teu artefacto custa {p} ARP em vez de {l}, e tens {b}.',
        ...
        br: {
            goCC: 'Clique nesta linha para ir à seção dela no Centro de controle.', goHere: 'Clique nesta linha para descer até a seção dela e destacá-la.', goPass: 'Clique nesta linha para ir ao passe de batalha.', goStore: 'Clique nesta linha para ir à loja de batalha.', goVault: 'Clique nesta linha para ir ao Cofre e dar lance. Também marca o aviso como visto.',
            ...
            tipTagDisc: 'Com o desconto do seu artefato custa {p} ARP em vez de {l}, e você tem {b}.',
        ...
        zh: {
            goCC: '点击本行前往控制中心里对应的部分。', goHere: '点击本行即可滚动到对应的部分并将其高亮。', goPass: '点击本行前往战斗通行证。', goStore: '点击本行前往战斗商店。', goVault: '点击本行前往宝库出价。同时会把该提醒标记为已看。',
            ...
            tipTagDisc: '算上你神器的折扣需要 {p} ARP（原价 {l}），你有 {b}。',
        ...
        hi: {
            goCC: 'कंट्रोल सेंटर में इसके हिस्से पर जाने के लिए इस पंक्ति पर क्लिक करें।', goHere: 'इसके हिस्से तक नीचे जाने और उसे हाइलाइट करने के लिए इस पंक्ति पर क्लिक करें।', goPass: 'बैटल पास पर जाने के लिए इस पंक्ति पर क्लिक करें।', goStore: 'बैटल स्टोर पर जाने के लिए इस पंक्ति पर क्लिक करें।', goVault: 'Game Vault पर जाकर बोली लगाने के लिए इस पंक्ति पर क्लिक करें। यह चेतावनी को देखा हुआ भी चिह्नित कर देता है।',
            ...
            tipTagDisc: 'आपके आर्टिफ़ैक्ट की छूट के साथ इसकी कीमत {l} की जगह {p} ARP है, और आपके पास {b} हैं।',
    ...
    //
    // Y no va al servidor a secas, va al CANAL «Arena Connect» —el segundo id—,
    // que es donde se vota en las encuestas que pagan el ARP de esta línea
    // (usuario, 2026-08-30). Llevar al servidor dejaba al usuario en el canal
    // que Discord decidiera, normalmente el último que hubiera mirado, y desde
    // ahí todavía había que encontrar el sitio. Una línea que dice DÓNDE se
    // cumple y te deja a un canal de distancia hace la mitad del trabajo.
    //
    // El id del canal no está en ninguna página de AWA, igual que el del gremio:
    // lo aportó el usuario y se deja escrito aquí para no volver a preguntarlo.
    const DISCORD_URL = 'https://discord.com/channels/97149047281827840/1069815226045833296';
    ...
    function readAccount() {
        ...
        return {
            ...
            // El descuento de un artefacto de Idioma (Mysterious Text: −1 %), como factor:
            // 0.99 con la carta equipada, 1 sin ella. Visto el 2026-09-25
            // (dom-marketplace-artifact-discount-2026-09-25.html).
            langDiscount: typeof g('artifactLangDiscount') === 'number' ? g('artifactLangDiscount') : 1,
        };
    }
    ...
    function readDaily(doc) {
        ...
        const salida = {
            ...
            // Lo que un artefacto Tech suma al tope (Scion of the Light: +1). Llega
            // APARTE de `totalPoints`, que sigue topado en 15, y solo cuando esos 15
            // ya están: con 15 cobrados y el bonus pendiente el sitio dice
            // `underCap: true` y `bonusPoints: 0`. Visto el 2026-09-25
            // (dom-control-center-twitch-scion-bonus-2026-09-25.html).
            twitchBonus: tw ? (tw.bonusPoints || 0) : 0,
            twitchDone: tw ? tw.underCap === false
                : !!(twitchSt && /complete/i.test(twitchSt.textContent) && !/incomplet/i.test(twitchSt.textContent)),
            // Si el sitio dijo algo FIABLE sobre el estado. Sin esto, «no terminado»
            // y «no lo sé» se leen igual, y solo en el segundo caso vale comparar con
            // 15. Solo cuenta el booleano: el texto del estado lo traduce Weglot
            // («Completo» no casa con /complete/), y darlo por dicho pintaba
            // «15/15+» con el día hecho en cuanto faltara `dailyArpData`.
            twitchKnown: !!tw,
    ...
    function readEventosIndice(doc) {
        ...
        // TODOS los vivos, no el primero. Hasta 1.3.4 aqui habia un `return` dentro del bucle, y el
        // 2026-09-23 se vieron dos a la vez (Warframe del 23-sep al 10-oct y Aniimo del 21 al
        // 30-sep, volcado dom-steam-events-index-two-live-2026-09-23.html): el panel enseño solo
        // Warframe, que es el que el indice pone primero, y Aniimo —el que acababa antes— no salia
        // en ningun sitio. Se ordenan por el que TERMINA antes, que es el que corre prisa; el orden
        // del indice (el que abrio mas tarde, primero) no dice nada de eso. `sort` es estable, asi
        // que dos con el mismo fin se quedan como los trae el indice.
        return vivos.sort((x, y) => x.hasta - y.hasta);
    }
    ...
    // La cache pasa a llevar una LISTA de eventos desde que se vieron dos vivos a la vez (ver
    // readEventosIndice). Una escrita por 1.3.x lleva el unico evento en la raiz, y se lee como
    // una lista de uno CON EL INDICE CADUCADO, para que la primera carga lo vuelva a pedir.
    //
    // Lo de caducarlo no es prudencia, es el fallo que se vio al estrenarlo el 2026-09-23: la
    // primera version conservaba su `idxAt` —«que el dia del cambio no cueste una peticion de
    // mas»— y el panel siguio enseñando solo Warframe hasta pulsar ⟳. Una cache de 1.3.x NO PUEDE
    // saber si habia mas eventos, porque quien la escribio dejaba de mirar en el primero; darla
    // por buena era congelar el bug que se acababa de arreglar hasta las 00:00 UTC. Cuesta UNA
    // peticion al indice, una vez por navegador.
    //
    // La de «no hay ninguno» si se conserva: ahi 1.3.x miraba el indice entero, asi que decia la
    // verdad. Su `idxAt` puede faltar (1.3.0 solo guardaba `at`), y entonces vale `at`, como antes.
    function eventosDe(g) {
        if (!g) return null;
        const idxAt = g.idxAt || g.at;
        if (Array.isArray(g.eventos)) return Object.assign({}, g, { idxAt: idxAt });
        if (!g.hay || !g.url) return { hay: false, at: g.at, idxAt: idxAt, eventos: [] };
        const uno = Object.assign({}, g);
        delete uno.hay; delete uno.idxAt;
        return { hay: true, idxAt: 0, eventos: [uno] };
    }

    // «Warframe Community Event» -> «Warframe», para distinguir las lineas cuando hay mas de un
    // evento vivo. El nombre sale del <noscript> del indice, que va SIEMPRE en ingles —Weglot no
    // lo traduce—, asi que el sufijo es fijo. Si no queda nada, null, y la linea lleva la etiqueta
    // de siempre.
    function evCorto(ev) {
        const n = ev && ev.nombre ? String(ev.nombre).replace(/\s*Community\s+Event\b.*$/i, '').trim() : '';
        return n || null;
    }

    function getEvento(forzar) {
        let guardado = null;
        try { guardado = eventosDe(JSON.parse(recall(EVENT_KEY) || 'null')); } catch (e) { /* cache ilegible */ }
        ...
        // y el documento solo aporta TU estado dentro de uno que el indice ya dio por
        ...
        const esEste = (ev) => !!(aqui && ev && ev.url && yaEstoyEn(ev.url));

        const ahora = Date.now();
        // `idxAt` es de cuando se leyo el INDICE, y cada evento lleva su propio `at`, de cuando se
        // leyo TU ESTADO en el. Van por separado porque caducan por separado: estando en la pagina
        // de uno, ese se renueva gratis y el otro sigue con la edad que tenga.
        const indiceVale = !!(guardado && utcStamp(guardado.idxAt) === utcStamp(ahora));
        const caducado = (ev) => !(ev.at && (ahora - ev.at) < EVENT_TTL_MS);

        const guardar = (eventos, idxAt) => {
            const dato = { hay: eventos.length > 0, at: ahora, idxAt: idxAt, eventos: eventos };
            store(EVENT_KEY, JSON.stringify(dato));
            return dato;
        };
        // Pone al dia cada evento de la lista. El de la pagina en la que estas sale del documento,
        // que es gratis y siempre fresco; los demas se piden, todos o solo los caducados. Si una
        // peticion falla, ese evento se queda con lo que ya tenia —su estado viejo y su `at` viejo,
        // asi que se reintenta en la siguiente carga— en vez de tirar la lista entera, que es lo
        // que pasaba con un solo evento y un solo `.catch`.
        const ponerAlDia = (lista, soloCaducados, idxAt) => Promise.all(lista.map((ev) => {
            if (esEste(ev)) return Object.assign({}, ev, aqui);
            if (soloCaducados && !caducado(ev)) return ev;
            return pedir(ev.url)
                .then((h) => {
                    const est = readEventoPagina(new DOMParser().parseFromString(h, 'text/html'));
                    return Object.assign({}, ev, { at: ahora }, est || {});
                })
                .catch(() => ev);
        })).then((eventos) => guardar(eventos, idxAt));

        if (!forzar && indiceVale) {
            ...
            if (!guardado.eventos.length) return Promise.resolve(guardado);
            // Con el indice todavia bueno se piden SOLO las paginas de evento caducadas. Es el
            // caso que mas se repite mientras hay alguno vivo.
            if (!guardado.eventos.some(esEste) && !guardado.eventos.some(caducado)) return Promise.resolve(guardado);
            return ponerAlDia(guardado.eventos, true, guardado.idxAt);
        }
        return pedir(EVENTS_URL)
            .then((html) => {
                const vivos = readEventosIndice(new DOMParser().parseFromString(html, 'text/html'));
                // Que no haya evento es un dato, y se guarda: si no, cada carga de cada pagina
                // volveria a pedir el indice para no encontrar nada.
                if (!vivos.length) return guardar([], ahora);
                // Cada vivo arranca con lo que ya se sabia de el, para que un fallo de red al
                // pedir su pagina no lo deje sin estado. Las fechas y el nombre, del indice.
                const previos = (guardado && guardado.eventos) || [];
                const lista = vivos.map((v) =>
                    Object.assign({}, previos.find((p) => p.url === v.url) || {}, v));
                return ponerAlDia(lista, false, ahora);
            })
            .catch(() => null);
    }
    ...
    // ------------------------------------------------------------------
    // Las líneas que se cumplen en el Centro de control, a SU sección
    // ------------------------------------------------------------------
    // Llevar a la página a secas dejaba al usuario arriba del todo buscando la tarjeta, y
    // estando YA en el Centro de control esas líneas no hacían nada. Ahora bajan a la sección
    // y la resaltan un momento, se esté donde se esté.
    //
    // Las secciones no tienen id. Se encuentran por lo que el panel ya lee de cada una —el
    // mismo selector, así que si el sitio lo cambia, falla la lectura antes que el salto— y se
    // sube a su tarjeta. «Tiempo en el sitio» no vive en ninguna: es el bloque de texto de la
    // franja de arriba, y ese es su destino. Verificado en los cuatro volcados del Centro de
    // control, de agosto a septiembre: Twitch, diarias y Steam, cada una en su tarjeta.
    const CC_SECCION = { tos: SEL.tosArp, twitch: SEL.twitchArp, qDaily: SEL.questLink, qSteam: SEL.steamStatus };
    const FOCO_KEY = 'awa-arp-foco';
    const FOCO_MS = 2600;

    function seccionCC(clave) {
        const sel = CC_SECCION[clave];
    ...
    // Devuelve la acción de la línea, o null si no hay adónde ir. Desde otra página deja
    // apuntada la sección en `sessionStorage` —de esta pestaña y solo de ella, no viaja a las
    // demás— y la recoge `enfocarPendiente` al cargar el Centro de control.
    function irASeccion(clave) {
        if (yaEstoyEn(CC_URL)) return seccionCC(clave) ? () => enfocar(clave) : null;
        return () => {
            try { sessionStorage.setItem(FOCO_KEY, JSON.stringify({ clave: clave, at: Date.now() })); }
            catch (e) { /* sin almacenamiento: se llega a la página igual, sin bajar */ }
            location.href = CC_URL;
        };
    }

    // Un minuto de margen: si la navegación se cortó y vuelves al Centro de control más tarde
    // por tu cuenta, no tiene sentido que baje solo a una tarjeta que ya no pediste.
    function enfocarPendiente() {
        if (!yaEstoyEn(CC_URL)) return;
        let f = null;
        try {
            f = JSON.parse(sessionStorage.getItem(FOCO_KEY) || 'null');
            sessionStorage.removeItem(FOCO_KEY);
        } catch (e) { return; }
        if (!f || !CC_SECCION[f.clave] || !(Date.now() - f.at < 60 * 1000)) return;
    ...
    function renderDaily(list, relojes, daily, cal, pass, discord, evento, acc) {
        ...
        // Las cuatro del Centro de control llevan cada una a SU sección (ver irASeccion); en
        // el propio Centro de control bajan a ella en vez de quedarse sin acción.
        const aSec = (clave) => {
        ...
        if (!daily) {
            ...
            if (daily.tos !== null && daily.tosMax !== null) {
                ...
                const a = aSec('tos');
                enlazar(pinta('tos', t('tos'), cuenta(daily.tos, daily.tosMax, hecho),
                    tipMas(t('tipTos'), a.tip), hecho ? 'done' : 'todo'), a.ir);
            }
            ...
            if (daily.twitch !== null) {
                ...
                //
                // Y al revés: 15 no es terminado si el sitio dice que no. Un
                // artefacto Tech sube el tope, y hasta 1.3.5 el panel pintaba
                ...
                const tope = TWITCH_CAP + (daily.twitchBonus || 0);
                const pend = !hecho && daily.twitch >= tope;
                const cifra = hecho ? cuenta(daily.twitch, Math.max(tope, daily.twitch), true)
                    : pend ? t('ofCap', { v: nf.format(daily.twitch), c: nf.format(tope) + '+' })
                        : cuenta(daily.twitch, tope, false);
                // Un tope que no es el 15 que dice el tooltip tiene que explicarse
                // en el propio tooltip. Sin nombrar la carta: hay más de una que
                // lo sube, y no todas lo mismo. Con bonus pendiente manda ese
                // texto aunque ya haya llegado parte: el tope de verdad no se sabe.
                const porque = pend ? ' ' + t('tipTwitchPend')
                    : tope > TWITCH_CAP ? ' ' + t('tipTwitchBonus', { c: nf.format(tope) }) : '';
                const a = aSec('twitch');
                enlazar(pinta('twitch', t('twitch'), cifra,
                    tipMas(t('tipTwitch') + porque, a.tip), hecho ? 'done' : 'todo'), a.ir);
            ...
            if (daily.dailyPending !== null && daily.dailyTotal) {
                ...
                enlazar(pinta('qDaily', t('qDaily'),
                    ...
                    tipMas(t('tipDaily'), a.tip), hecho ? 'done' : 'todo'), a.ir);
            }
            ...
            if (daily.steamPending !== null && daily.steamTotal) {
                ...
                enlazar(pinta('qSteam', t('qSteam'),
                    ...
                    tipMas(t('tipSteam'), a.tip), hecho ? 'done' : 'todo'), a.ir);
            }
        }
        ...
        // Los eventos comunitarios. Solo existe la linea si hay uno vivo: fuera de esa
        // ventana no hay nada que decir, y una linea permanente en gris seria
        // ruido once meses al ano.
        //
        // UNA LINEA POR EVENTO, y no una que los resuma: el 2026-09-23 hubo dos a la vez, y una
        // sola fila no sabria a cual enlazar. Cada una lleva su estado, su flecha y su reloj,
        // porque cada evento pide lo suyo (en aquel caso, los dos juegos sin poseer). Con uno solo
        // la etiqueta sigue siendo la de siempre; con varios lleva el nombre del juego, que es lo
        // unico que las distingue.
        const eventos = (evento && evento.hay && evento.eventos) || [];
        const varios = eventos.length > 1;
        eventos.forEach((ev) => {
            const aEvento = ev.url ? irA(ev.url) : null;
            const corto = varios ? evCorto(ev) : null;
            let valor, tono, cualTip;
            if (ev.estado === 'unowned') {
                valor = t('evOwn'); tono = 'todo'; cualTip = 'tipEvOwn';
            } else if (ev.estado === 'unjoined') {
                ...
                if (!hitos.length || (!falta && leidos.length !== hitos.length)) { valor = t('evOn'); tono = 'done'; }
                ...
                else if (ev.minutos === null || ev.minutos === undefined) { valor = t('evOn'); tono = 'done'; }
                else {
                    ...
                    valor = t('evMin', { v: nf.format(ev.minutos), c: nf.format(falta.meta) });
                    tono = 'done';
                }
            }
            enlazar(pinta('evento', corto ? t('evNamed', { n: corto }) : t('evento'), valor,
        ...
        // Con varios eventos, uno por cada uno y con su nombre delante: dos «Evento: 7d» y
        // «Evento: 16d» a secas no dicen cual es cual.
        eventos.forEach((ev) => {
            if (!ev.hasta) return;
            const quedan = fmtCountdown(ev.hasta - now.getTime());
            const corto = varios ? evCorto(ev) : null;
    ...
    // Lo que de verdad se paga en el Marketplace. `data-product-price` es el precio de LISTA
    // aunque lleves un artefacto de descuento: el sitio pinta al lado el rebajado
    // (`.arp-discount-new`) y lo redondea HACIA ABAJO —150 → 148, 60 → 59, 9999 → 9899, y así
    // las 38 tarjetas con precio del volcado—. Hasta 1.3.5 el panel comparaba el saldo con el de
    // lista, así que en el borde decía «te faltan 2 ARP» de algo que ya te alcanzaba.
    // El épsilon es por la coma flotante: 0.99 no es exacto, y un producto que debería dar un
    // entero podría quedarse una millonésima por debajo y perder un ARP al redondear.
    function precioReal(lista, acc) {
        const d = acc.langDiscount;
        if (lista === null || !(d > 0 && d < 1)) return lista;
        return Math.floor(lista * d + 1e-9);
    }

    function tagCard(card, price, tier, inStock, acc, lista) {
        ...
        tip(tag, price !== null && acc.balance !== null
            ? (lista !== undefined && lista !== null && lista !== price
                ? t('tipTagDisc', { p: nf.format(price), l: nf.format(lista), b: nf.format(acc.balance) })
                : t('tipTag', { p: nf.format(price), b: nf.format(acc.balance) }))
            : t('tipKeys'));
        card.appendChild(tag);
    }

    // Solo aquí se aplica el descuento de artefacto, y no en la Bóveda: la carta dice «items in
    // the Marketplace», y de la Bóveda no hay volcado con la carta puesta que diga si rebaja.
    function paintMarketplace(acc) {
        document.querySelectorAll(SEL.marketCard).forEach((card) => {
            ...
            const lista = num(card.getAttribute('data-product-price'));
            tagCard(card, precioReal(lista, acc), null,
                stock === null ? null : stock === 'true', acc, lista);
        });
    }
    ...
    //
    //   - `data-product-in-stock` no sigue al stock, sigue al final de la subasta:
    //     vale `true` mientras está abierta Y antes de abrir, y pasa a `false` solo
    //     cuando TERMINA. Verificado con los tres estados: abierta el 2026-09-18
    //     (STALKER 2 y Cronos, `true`), sin empezar el 2026-09-01 (los mismos dos,
    //     `true`) y terminada en agosto (Dinoblade, `false`). Hasta 1.3.1 este
    //     comentario decía lo contrario —`false` también con la subasta abierta—,
    //     inferido del único volcado que había entonces, que era el del final. Lo
    //     que sí rompe es la tarjeta cerrada: ahí `tagCard` rotularía «AGOTADO»
    //     donde toca «Subasta terminada», y no es lo mismo —un stock agotado se
    //     repone y una subasta que cerró no vuelve—.
    ...
    function injectCss() {
        ...
        css.textContent = [
            ...
            // El resaltado de la sección a la que lleva una línea (ver enfocar). Fuera del panel,
            // en las tarjetas del sitio: un contorno que se desvanece, sin mover nada de sitio.
            ...
            // POSICIONADO ENCIMA y centrado, y nuestra etiqueta se anade al final de esa
            // misma tarjeta: con el texto centrado los dos caen en la misma vertical y el
            // contador tapa medio letrero —«Puja desde 300 ARP» se leia «Puja desde ... ARP»,
            // justo la cifra con la que se decide—. Alinear al inicio saca el texto de debajo
            // sin mover nada del sitio. Va `start` y no `left` porque la etiqueta se traduce a
            // dieciseis idiomas, y scoped a `.auction-game` porque las tarjetas normales de la
            // Boveda y del Marketplace no llevan contador encima y ahi el centrado esta bien.
            '.auction-game .awa-tag{text-align:start;}',
